...
> **Two use-cases share this example.** Below: **Two Rooms** (generation, training, planning). For the **Maze** use-case — the same stack plus a learned hierarchy for **A\*-free** navigation (baseline → Level 1 → Level 2, all modular) — see **[`../maze/README.md`](../maze/README.md)**.
